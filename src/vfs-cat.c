...
int main(int argc, char *argv[]) {
    // estudiante1: comprobamos número de argumentos
    if (argc < 3) {
    ...
    // estudiante2: recorremos cada nombre de archivo pasado
    for (int i = 2; i < argc; i++) {
        const char *filename = argv[i];
        // estudiante1: buscamos el inode correspondiente al nombre
        ...
        int total_read = 0;
        // estudiante2: leemos en bloques hasta completar el tamaño
